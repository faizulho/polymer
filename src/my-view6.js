...
class MyView6 extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="card">
<h1>Contact Us</h1>
<p>Use this form to reach out to us regarding your questions and concerns. For reporting purposes and data subject requests, please use our <a ref="./my-view5.js">DSAR</a> form.</p>
